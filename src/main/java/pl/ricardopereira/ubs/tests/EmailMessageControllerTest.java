...
public class EmailMessageControllerTest {
	...
	private EmailService serviceMock = Mockito.mock(EmailService.class);
	...
	public void whenPostCalledInsertRecord() throws Exception {
        ...
        mockMvc.perform(post("/sendmessage/email")
	...
	public void whenPostCalledInsertRecordIntegration() throws Exception {
		...
		assertThat(MockDb.getEmailLog().listMessages().isEmpty(), is(false));
	}
